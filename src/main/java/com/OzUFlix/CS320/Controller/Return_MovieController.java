...
public class Return_MovieController {
    ...
    @GetMapping
    public List<Return_Movie> findAll(){ return Return_MovieService.findAll(); }

    @GetMapping("/{Return_Movie-id}")
    public Return_Movie getReturn_MovieById(@PathVariable("Return_Movie-id") int id) {return Return_MovieService.findById(id); }
